...
class Search {
  ...
  async getResults() {
    try {
      const [postsResponse, pagesResponse] = await Promise.all([axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`${universityData.root_url}/wp-json/wp/v2/posts?search=${this.searchField.value}`), axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`${universityData.root_url}/wp-json/wp/v2/pages?search=${this.searchField.value}`)]);
      console.log("Posts Response:", postsResponse);
      console.log("Pages Response:", pagesResponse);
      const combinedResults = [...postsResponse.data, ...pagesResponse.data];
      ...
      if (combinedResults.length === 0) {
        ...
        htmlContent += combinedResults.map(item => `
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkuniversitytheme"] = globalThis["webpackChunkuniversitytheme"] || [];
